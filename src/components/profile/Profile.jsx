...
const Profile = () => {
    ...
    return (
        <div className=" w-[95%] mx-auto lg:w-[80%] mt-10 text-[#032443] bg-[#F7F5F5] p-3">
            ...
            <div className="p-10 flex flex-col justify-center items-center gap-2 space-y-5 space-x-3">
                ...
                <div className=" space-y-4">
                    <p className=" tracking-widest">Username: {user.first_name}</p>
                    <p className=" tracking-widest">Full_name : {user.last_name}</p>
                    <p className=" tracking-widest">Email : {user.email}</p>
