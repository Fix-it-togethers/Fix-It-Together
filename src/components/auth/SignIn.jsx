    ...
    return (
        <div className=" w-[95%] mx-auto lg:w-[75%] lg:ml-[22%] mt-10 lg:mt-14 text-[#474E68] bg-white p-3 rounded shadow-sm">
            <div className='lg:h-[29rem] bg-white mt-10 lg:mt-0 grid grid-cols-1 lg:grid-cols-2 p-4 space-y-5 lg:space-y-2'>
                <div className='bg-[#03256C] text-white rounded flex flex-col lg:justify-center lg:items-center space-y-3 p-8 lg:p-3'>
                ...
                <div className=' mt-20 lg:mt-0  text-[#03256C]'>
                    ...
                    <Formik initialValues={initialValues}
                        ...
                        <Form className='text-[#03256C] mt-5 flex flex-col lg:justify-center lg:items-start lg:space-x-5  space-y-7'>
                            ...
                            <button className='p-3 border-2 lg:w-[80%] bg-[#03256C] text-white outline-none rounded-md' type='submit'>Login</button>
                        </Form>
                    </Formik>
                </div>
            </div>
